...
public class UpdateImageAsyncShould
{
    ...
    [Fact]
    public async Task ThrowNuggetImageIsEmptyException()
    {
        var act = async () => await _nuggetDomain.UpdateImageAsync(
            new UpdateNuggetImageCommand(
                GoodGuidNugget,
    ...
    [Fact]
    public async Task UpdateImageNuggetDoesNotBelongToUserException()
    {
        var act = async () => await _nuggetDomain.UpdateImageAsync(
            new UpdateNuggetImageCommand(
                GoodGuidNugget,
    ...
    [Fact]
    public async Task UpdateImageNuggetWithNormalUser()
    {
